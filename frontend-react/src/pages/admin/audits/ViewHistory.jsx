...
import { Search, RotateCcw, Eye, Loader2, Wallet, QrCode, FileSpreadsheet } from "lucide-react";
      ...
      <div className="bg-white rounded-2xl border shadow-sm p-6">
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-4.5 bg-[#107c41] hover:bg-[#0a5c30] text-white font-bold text-xs rounded-lg shadow-sm transition-all h-8.5 shrink-0 disabled:opacity-40 disabled:cursor-not-allowed"
