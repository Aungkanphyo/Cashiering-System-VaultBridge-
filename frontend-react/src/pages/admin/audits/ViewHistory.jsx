...
const ViewHistory = () => {
  // Static state holding standard transaction data structure
  const [transactions, setTransactions] = useState([
    {id: "6001", dateTime: "06-06-2006 09:15:30", subtotal: 24000, totalTax: 1200, totalDiscount: 0, finalAmount: 25200, paymentMethod: "Cash", status: "COMPLETED", voidReason: "" },
    {id: "6002", dateTime: "06-07-2026 11:30:10", subtotal: 41000, totalTax: 1980, totalDiscount: 1400, finalAmount: 41580, paymentMethod: "KPay", status: "COMPLETED", voidReason: "" },
    {id: "6003", dateTime: "2026-06-07 13:45:22", subtotal: 12000, totalTax: 600, totalDiscount: 0, finalAmount: 12600, paymentMethod: "Cash", status: "VOIDED", voidReason: "Customer-selected wrong item"},
    {id: "6001", dateTime: "06-06-2006 09:15:30", subtotal: 24000, totalTax: 1200, totalDiscount: 0, finalAmount: 25200, paymentMethod: "Cash", status: "COMPLETED", voidReason: "" },
    {id: "6002", dateTime: "06-07-2026 11:30:10", subtotal: 41000, totalTax: 1980, totalDiscount: 1400, finalAmount: 41580, paymentMethod: "KPay", status: "COMPLETED", voidReason: "" },
    {id: "6003", dateTime: "2026-06-07 13:45:22", subtotal: 12000, totalTax: 600, totalDiscount: 0, finalAmount: 12600, paymentMethod: "Cash", status: "VOIDED", voidReason: "Customer-selected wrong item"},
    {id: "6001", dateTime: "06-06-2006 09:15:30", subtotal: 24000, totalTax: 1200, totalDiscount: 0, finalAmount: 25200, paymentMethod: "Cash", status: "COMPLETED", voidReason: "" },
  ...
  // Advanced Filter Handler (Sale ID, Payment Method, Status)
  ...
  const handleViewVoucher = (id) => {
    console.log(`Viewing voucher details for ID: #${id}`);
  };
          ...
          <table className="w-full text-left border-collapse min-w-[1000px] table-auto">
            <thead>
              <tr className="bg-[#08694b] text-white text-xs uppercase font-bold tracking-wider select-none">
                ...
                <th className="py-4 px-5 text-right">Total Tax</th>
                ...
                <th className="py-4 px-5 text-center">Transaction Status</th>
                <th className="py-4 px-5 text-center w-32">Details</th>
              </tr>
            </thead>
              ...
              {currentRows.length > 0 ? (
                currentRows.map((tx, idx) => (
                  ...
                  >
                    ...
                    {/* Total Tax */}
                    <td className={`py-4 px-5 text-right font-mono text-emerald-600 whitespace-nowrap ${tx.status === "VOIDED" ? "opacity-40" : ""}`}>
                      +{tx.totalTax.toLocaleString()} Ks
                    </td>
                    ...
                    {/* Payment Method Column (Cash: Green, KPay: Navy Blue) */}
                    <td className="py-4 px-5 text-center whitespace-nowrap">
                      {tx.paymentMethod === "Cash" ? (
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-emerald-50 text-emerald-600 border border-emerald-200 text-xs font-bold">
                          💵 Cash: {tx.finalAmount.toLocaleString()}
                        </span>
                      ) : (
                    ...
                    <td className="py-4 px-5 text-center whitespace-nowrap">
                      {tx.status === "COMPLETED" ? (
                        ...
                        <div className="flex flex-col items-center justify-center">
                          ...
                          {tx.voidReason && (
                            <span className="text-[10px] text-red-400 font-medium italic mt-0.5 max-w-[150px] truncate" title={tx.voidReason}>
                              {tx.voidReason}
                            </span>
                          )}
                        </div>
                    ...
                    {/* Details Action Button (Green Theme matched) */}
                    <td className="py-4 px-5 text-center">
                      <button
                        onClick={() => handleViewVoucher(tx.id)}
